...
export function install(app) {
  app.config.globalProperties.$$ps = {
    _vm: null,
    init(vm) {
      this._vm = vm
    },
...
export default {
  ...
  computed: {
    gatherer_image() {
      return `http://gatherer.wizards.com/Handlers/Image.ashx?multiverseid=${this.multiverse_id}&type=card`
    },
  },
  methods: {
    reset() {
