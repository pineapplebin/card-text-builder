<template>
  <base-card>
    ...
    <div class="main">
      <name-block
        :name="cardData.name"
        :is-legendary="cardData.is_legendary"
      ...
      <effect-block
        ...
        :watermark="cardData.effect_watermark"
      ></effect-block>
      <series-block
        style="margin-top: 10px"
        :series="cardData.series"
        :number="$$tools.getNumberFromImage(cardData.image_url)"
        :rarity="$$tools.getSeriesRarity(cardData.rarity, cardData.type)"
      ></series-block>
      <body-block
        v-show="cardData.is_creature"
        :bottom="20"
        :right="20"
        :border="cardData.border_style"
        :body="cardData.body"
