  ...
  <base-card>
    ...
    <div class="main">
      ...
      <type-block
        ...
        :border="cardData.border_style"
        :indicator="cardData.indicator"
      ></type-block>
      <effect-block
        class="effect-block"
        :border="cardData.border_style"
        :effect="cardData.effect"
        :height="rendered_effects.length < 4 ? 177 : 217"
      >
          ...
          <div class="single-effect" v-for="(eff, idx) in rendered_effects" :key="idx">
            ...
            <div class="counter">
              <div class="loyalty-counter" v-if="eff.counter">
                ...
                <img v-else-if="eff.counter[0] === '−'" src="../../assets/images/loyalty/minus.png" />
      ...
      <series-block
        ...
        :rarity="$$tools.getSeriesRarity(cardData.rarity)"
      ></series-block>
      <div class="loyalty">
...
const form = {
  ...
  ...common_conf,
  bg_style: SelectField({
    label: '背景样式',
    options: getBgOptions(opt => opt.value.match(/pw/)),
  }),
...
export default {
  ...
  computed: {
    rendered_effects() {
      if (!this.cardData.pw_effect) return []
